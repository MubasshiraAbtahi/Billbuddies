...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Notify all group members except the user who added the expense
    foreach ($members as $member) {
        if ($member['user_id'] != $paid_by) {
            $message = "A new expense has been added to the group.";
            $type = "expense_added";  // Type of notification
            add_notification($member['user_id'], $message, $type, $conn);
        }
    }
